...
class MujocoRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            done_episodes_costs = []
            # Custom env info accumulator (for analytic priors logging)
            custom_env_infos = {}
            ...
            for step in range(self.episode_length):
                ...
                for t in range(self.n_rollout_threads):
                    ...
                    if dones_env[t]:
                        ...
                        # Collect custom episode-end info (analytic priors etc.)
                        try:
            ...
            if episode % self.log_interval == 0:
                ...
                # Log custom env info (analytic priors + episode stats)
                if custom_env_infos:
