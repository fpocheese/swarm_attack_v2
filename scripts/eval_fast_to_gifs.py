...
def main():
    ...
    model_dir = os.path.join(project_root, 'outputs', 'results', 'fov_penetration', 'macpo', 'v3_scenario1_fast', 'run3', 'models')
    out_dir = os.path.join(project_root, 'outputs', 'gifs', 'fast_run3_eval_10eps')
