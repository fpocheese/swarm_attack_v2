#!/bin/bash
# =====================================================
# V20 Training - 修复safety_bound根因
# 核心改动: safety_bound 0.1→50, ap_config none, action_scale恢复0.5
# =====================================================
...
echo "KEY FIX: safety_bound=50 (was 0.1), ap_config=none, action_scale=0.5" | tee -a "$LOGFILE"
