...
DEFAULT_CONFIG = {
    ...
    "reward": {
        ...
        "approach_hvt_coef": 500.0,         # 个人接近HVT: 强
        "team_progress_coef": 300.0,        # 全队最近距离进步: 核心协同
        "progress_coef": 0.3,              # 进度奖励: 靠近就给
        "retreat_penalty": -0.15,          # 后退惩罚: 远离HVT扣分
        "decoy_lure_coef": 0.3,            # 诱饵拉走拦截器奖励
        "mutual_kill_team_bonus": 100.0,   # 同归于尽全队共享: 核心协同
        "detected_penalty": -0.01,         # 被探测: 极轻
        "fov_escape_bonus": 2.0,           # 脱离FOV
